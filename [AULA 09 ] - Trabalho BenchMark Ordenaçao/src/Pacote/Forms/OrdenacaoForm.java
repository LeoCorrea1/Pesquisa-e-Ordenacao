...
public class OrdenacaoForm extends javax.swing.JFrame {
   ...
   private java.util.List<String> MetodosSelecionados() {
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(chkBolha);
        chkBolha.setText("Metodo Bolha");

        buttonGroup1.add(chkInsercao);
        chkInsercao.setText("Metodo Inserção");

        buttonGroup1.add(chkSelecao);
        ...
        buttonGroup1.add(chkMerge);
        chkMerge.setText("Metodo Merge");

        buttonGroup1.add(chkQuick);
    ...
    for (String method : metodos) {
        ...
        txtResultado.append("Método: " + method + "\n");
        txtResultado.append("Comparações: " + res.comparacoes + "\n");
        txtResultado.append("Trocas: " + res.trocas + "\n");
